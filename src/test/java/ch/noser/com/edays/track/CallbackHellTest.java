    ...
    public void ThreadExampleTest() throws InterruptedException {
        CompletableFuture.supplyAsync(() -> "URL")
                .whenComplete((result, e) -> {
                    ...
                    //Download from ULL
                    if (result != null) {
                        CompletableFuture.supplyAsync(() -> ValidationTasks.download(result))
                                .whenComplete((resultLevel2, eLevel2) -> {

                                    //Next Level
                                    if (resultLevel2 != null) {
                                        //we have to go deeper
                                        System.out.println("we did it:" + resultLevel2);
                                    } else {
                                        //ErrorHandling
                                    }
